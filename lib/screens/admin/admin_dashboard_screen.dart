            ...
            children: [
              ...
              _mgmtTile(
                  ...
                  () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const _AllBookingsScreen()))),
              const SizedBox(height: 28),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Text('New Parking: ${spot.name}',
              style: GoogleFonts.poppins(
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
                  color: AppColors.textPrimary)),
          Text('Submitted by ${spot.ownerName}',
              style: GoogleFonts.poppins(
                  fontSize: 12, color: AppColors.textSecondary)),
          Text(spot.address,
              style:
        ...
        Icon(Icons.arrow_forward_ios_rounded,
            size: 14, color: AppColors.textHint.withValues(alpha: 0.4)),
      ]),
    );
  }
}
                      ...
                      children: [
                        Text('${pendingSpots.length}',
                            style: GoogleFonts.poppins(
                                ...
                                height: 1)),
                        const SizedBox(height: 4),
                        Text('Pending Parking Approvals',
                            style: GoogleFonts.poppins(
                                fontSize: 15,
                                fontWeight: FontWeight.w500,
                                color: Colors.white.withValues(alpha: 0.85))),
                  ...
                  child: Center(
                      ...
                      Text('All caught up!',
                          style: GoogleFonts.poppins(
                              ...
                              color: AppColors.textSecondary)),
                      const SizedBox(height: 4),
                      Text('No pending parking approvals',
                          style: GoogleFonts.poppins(
