        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ── Stat Cards Grid ──
              Row(children: [
                Expanded(child: _statCard(context, 'Users', 'Manage',
                ...
                Expanded(child: _statCard(context, 'Spaces', 'Manage',
              ...
              Row(children: [
                Expanded(child: _statCard(context, 'Bookings', 'View All',
                ...
                const SizedBox(width: 12),
                Expanded(child: _statCard(context, 'Revenue', 'Analytics',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(value, style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w700, color: AppColors.textPrimary, height: 1)),
